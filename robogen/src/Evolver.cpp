...
void init(unsigned int seed, std::string outputDirectory,
	...
	population->evaluate(robotConf, sockets); 
        std::cout<<"DONE WITH FIRST EVALUATION."<<std::endl;
	...
	if(conf->noveltySearch){
                std::cout<<"NOVELTY SEARCH SPECIFIC EVALUATIONS. . ."<<std::endl;
		...
		while(It!=pop.end()){
			...
			It++;
                ...
                std::cout<<"ADDED TO ARCHIVE SUCCESSFULLY. SIZE: "<<noveltyArchive.size()<<std::endl;
		population->evaluateNovelty(noveltyArchive, pop);//changed to a call for second novelty metric
                std::cout<<"DONE EVALUATING NOVELTY OF POPULATION."<<std::endl;
		std::sort(population->begin(),population->end(),
                ...
                std::cout<<"DONE SORTING POPULATION."<<std::endl;
	}
        std::cout<<"END OF init METHOD"<<std::endl;
}//end of init
