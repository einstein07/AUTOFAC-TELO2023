...
Robot::Robot() :
		connectionJointGroup_(NULL), isBoundToResource_(false) {
...
void Robot::setBoundToResource(bool isBoundToResource){
    isBoundToResource_ = isBoundToResource;
}

const bool Robot::isBoundToResource(){
    return isBoundToResource_;
}
}
